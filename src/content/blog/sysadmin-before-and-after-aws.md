...
Looking back at those two periods, what changed wasn't just my own experience — the job itself changed. Platforms like AWS didn't make the systems administrator's work easier, they made it a different job. Ten years ago, a systems administrator was someone who knew how to keep a machine alive; today, it's closer to someone who knows how to compose managed services into an architecture that holds up on its own. It's a less mechanical skill and a more architectural one — which is probably why, the second time I found myself doing it, it felt like a new job, not a return to the first one.
